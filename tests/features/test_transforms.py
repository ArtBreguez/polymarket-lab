...
import pandas as pd
import pytest
from pmlab.features.transforms import add_lags, add_rolling_stats, clip_outliers, encode_cyclical, encode_onehot

@pytest.fixture
def sample_df():
    return pd.DataFrame({"city": ["A","A","A","B","B","B"], "temp": [20.,22.,24.,15.,17.,19.], "humidity": [50.,55.,60.,40.,45.,50.]})
